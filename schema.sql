...
\restrict nelqN0KEJEmir87KpqXHnK1dieLIzWnztWQ4e9VfcRRwtV2qJCaIQuYis9mlwdO
...
--
-- Name: Auth Providers; Type: TYPE; Schema: public; Owner: postgres
--
...
--
-- Name: TYPE "Auth Providers"; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: housekeeping_compact_old_workouts(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.housekeeping_compact_old_workouts() RETURNS void
...
-- 1) distinct workout days per user, based ONLY on workout_summary.start_utc
days AS (
  SELECT
...
-- 4) delete ALL tracking rows that belong to those old days
...
--
-- Name: is_owner_of_workoutsplit(bigint); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.is_owner_of_workoutsplit(split_id_in bigint) RETURNS boolean
    LANGUAGE sql STABLE
    AS $$
  SELECT EXISTS (
    SELECT 1
...
--
-- Name: refresh_user_split_information(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.refresh_user_split_information() RETURNS void
    LANGUAGE sql
    AS $$-- English comments only inside the code
...
--
-- Name: update_muscle_group_trigger_function(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.update_muscle_group_trigger_function() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: exercisetoworkoutsplit; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.exercisetoworkoutsplit (
    id bigint NOT NULL,
...
--
-- Name: ExerciseToWorkoutsplit_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
--
-- Name: aerobictracking; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.aerobictracking (
    id bigint NOT NULL,
    user_id uuid NOT NULL,
    type text NOT NULL,
...
--
-- Name: TABLE aerobictracking; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: aerobictracking_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
--
-- Name: exercisetracking; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE exercisetracking; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: exercisetracking_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE oauth_accounts; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN oauth_accounts.linked_at; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN oauth_accounts.missing_fields; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: user_reminder_settings; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: user_split_information; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.user_split_information (
    id bigint NOT NULL,
    user_id uuid NOT NULL,
...
--
-- Name: user_split_information_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.user_split_information_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: user_split_information_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: user_split_information_id_seq1; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
--
-- Name: users_subs; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.users_subs (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    user_id uuid NOT NULL,
...
--
-- Name: TABLE users_subs; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: workoutsplits; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.workoutsplits (
    id bigint NOT NULL,
...
--
-- Name: TABLE workoutsplits; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: v_exercisetoworkoutsplit_expanded; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.v_exercisetoworkoutsplit_expanded WITH (security_invoker='on') AS
 SELECT ews.id,
    ews.workoutsplit_id,
    ws.workout_id,
    ews.exercise_id,
...
--
-- Name: workout_summary; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.workout_summary (
    ...
    workout_end_utc timestamp with time zone,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    workoutsplit_id bigint NOT NULL
);
...
--
-- Name: v_exercisetracking_expanded; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.v_exercisetracking_expanded WITH (security_invoker='on') AS
 SELECT et.id,
...
--
-- Name: v_exercisetracking_set_simple; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.v_exercisetracking_set_simple WITH (security_invoker='on') AS
 SELECT et.id,
    et.exercisetosplit_id,
    et.exercise_id,
    et.exercise,
...
--
-- Name: v_prs; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.v_prs WITH (security_invoker='on') AS
...
--
-- Name: workoutplans; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.workoutplans (
    id bigint NOT NULL,
...
--
-- Name: TABLE workoutplans; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN workoutplans.level; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: workoutplan_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
--
-- Name: workoutsplits_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
--
-- Name: messages_2025_08_10; Type: TABLE; Schema: realtime; Owner: supabase_admin
--
...
ALTER TABLE realtime.messages_2025_08_10 OWNER TO supabase_admin;

--
-- Name: messages_2025_08_11; Type: TABLE; Schema: realtime; Owner: supabase_admin
--
...
ALTER TABLE realtime.messages_2025_08_11 OWNER TO supabase_admin;
...
--
-- Name: messages_2025_08_10; Type: TABLE ATTACH; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: messages_2025_08_11; Type: TABLE ATTACH; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: exercisetoworkoutsplit ExerciseToWorkoutsplit_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: aerobictracking aerobictracking_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: exercisetracking exercisetracking_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: oauth_accounts oauth_accounts_provider_user_unique; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: exercisetoworkoutsplit uq_ets_split_exercise; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: workoutsplits uq_workoutsplits_plan_name; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: user_reminder_settings user_reminder_settings_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: user_split_information user_split_information_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: user_split_information user_split_information_user_id_split_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: users users_id_key1; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: users_subs users_subs_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: workout_summary workout_summary_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: workoutplans workoutplan_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: workoutsplits workoutsplits_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: messages_2025_08_10 messages_2025_08_10_pkey; Type: CONSTRAINT; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: messages_2025_08_11 messages_2025_08_11_pkey; Type: CONSTRAINT; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: messages_2025_08_12 messages_2025_08_12_pkey; Type: CONSTRAINT; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: messages_2025_08_13 messages_2025_08_13_pkey; Type: CONSTRAINT; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: messages_2025_08_14 messages_2025_08_14_pkey; Type: CONSTRAINT; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: aerobictracking_user_id_workout_time_utc_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: exercisetoworkoutsplit_active_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: exercisetoworkoutsplit_workoutsplit_id_order_index_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: exercisetracking_workout_summary_id_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: uq_workoutplans_active_user; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: user_split_information_confidence_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: user_split_information_user_weekday_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: users_email_ci_unique; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: users_username_ci_unique; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: workout_summary_start_date_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: workout_summary_user_start_utc_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: workoutsplits_workout_id_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: messages_2025_08_10_inserted_at_topic_idx; Type: INDEX; Schema: realtime; Owner: supabase_admin
--

CREATE INDEX messages_2025_08_10_inserted_at_topic_idx ON realtime.messages_2025_08_10 USING btree (inserted_at DESC, topic) WHERE ((extension = 'broadcast'::text) AND (private IS TRUE));


--
-- Name: messages_2025_08_11_inserted_at_topic_idx; Type: INDEX; Schema: realtime; Owner: supabase_admin
--

CREATE INDEX messages_2025_08_11_inserted_at_topic_idx ON realtime.messages_2025_08_11 USING btree (inserted_at DESC, topic) WHERE ((extension = 'broadcast'::text) AND (private IS TRUE));


--
-- Name: messages_2025_08_12_inserted_at_topic_idx; Type: INDEX; Schema: realtime; Owner: supabase_admin
--

CREATE INDEX messages_2025_08_12_inserted_at_topic_idx ON realtime.messages_2025_08_12 USING btree (inserted_at DESC, topic) WHERE ((extension = 'broadcast'::text) AND (private IS TRUE));


--
-- Name: messages_2025_08_13_inserted_at_topic_idx; Type: INDEX; Schema: realtime; Owner: supabase_admin
--

CREATE INDEX messages_2025_08_13_inserted_at_topic_idx ON realtime.messages_2025_08_13 USING btree (inserted_at DESC, topic) WHERE ((extension = 'broadcast'::text) AND (private IS TRUE));


--
-- Name: messages_2025_08_14_inserted_at_topic_idx; Type: INDEX; Schema: realtime; Owner: supabase_admin
--

CREATE INDEX messages_2025_08_14_inserted_at_topic_idx ON realtime.messages_2025_08_14 USING btree (inserted_at DESC, topic) WHERE ((extension = 'broadcast'::text) AND (private IS TRUE));


--
-- Name: messages_2025_08_15_inserted_at_topic_idx; Type: INDEX; Schema: realtime; Owner: supabase_admin
--

CREATE INDEX messages_2025_08_15_inserted_at_topic_idx ON realtime.messages_2025_08_15 USING btree (inserted_at DESC, topic) WHERE ((extension = 'broadcast'::text) AND (private IS TRUE));


--
-- Name: messages_2025_08_16_inserted_at_topic_idx; Type: INDEX; Schema: realtime; Owner: supabase_admin
--

CREATE INDEX messages_2025_08_16_inserted_at_topic_idx ON realtime.messages_2025_08_16 USING btree (inserted_at DESC, topic) WHERE ((extension = 'broadcast'::text) AND (private IS TRUE));
...
--
-- Name: messages_2025_08_10_inserted_at_topic_idx; Type: INDEX ATTACH; Schema: realtime; Owner: supabase_realtime_admin
--

ALTER INDEX realtime.messages_inserted_at_topic_index ATTACH PARTITION realtime.messages_2025_08_10_inserted_at_topic_idx;


--
-- Name: messages_2025_08_10_pkey; Type: INDEX ATTACH; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Name: messages_2025_08_11_inserted_at_topic_idx; Type: INDEX ATTACH; Schema: realtime; Owner: supabase_realtime_admin
--

ALTER INDEX realtime.messages_inserted_at_topic_index ATTACH PARTITION realtime.messages_2025_08_11_inserted_at_topic_idx;


--
-- Name: messages_2025_08_11_pkey; Type: INDEX ATTACH; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Name: messages_2025_08_12_inserted_at_topic_idx; Type: INDEX ATTACH; Schema: realtime; Owner: supabase_realtime_admin
--

ALTER INDEX realtime.messages_inserted_at_topic_index ATTACH PARTITION realtime.messages_2025_08_12_inserted_at_topic_idx;
...
--
-- Name: messages_2025_08_13_inserted_at_topic_idx; Type: INDEX ATTACH; Schema: realtime; Owner: supabase_realtime_admin
--

ALTER INDEX realtime.messages_inserted_at_topic_index ATTACH PARTITION realtime.messages_2025_08_13_inserted_at_topic_idx;
...
--
-- Name: messages_2025_08_14_inserted_at_topic_idx; Type: INDEX ATTACH; Schema: realtime; Owner: supabase_realtime_admin
--

ALTER INDEX realtime.messages_inserted_at_topic_index ATTACH PARTITION realtime.messages_2025_08_14_inserted_at_topic_idx;
...
--
-- Name: messages_2025_08_15_inserted_at_topic_idx; Type: INDEX ATTACH; Schema: realtime; Owner: supabase_realtime_admin
--

ALTER INDEX realtime.messages_inserted_at_topic_index ATTACH PARTITION realtime.messages_2025_08_15_inserted_at_topic_idx;
...
--
-- Name: messages_2025_08_16_inserted_at_topic_idx; Type: INDEX ATTACH; Schema: realtime; Owner: supabase_realtime_admin
--

ALTER INDEX realtime.messages_inserted_at_topic_index ATTACH PARTITION realtime.messages_2025_08_16_inserted_at_topic_idx;
...
--
-- Name: exercisetoworkoutsplit update_muscle_group_trigger; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER update_muscle_group_trigger AFTER INSERT OR DELETE OR UPDATE ON public.exercisetoworkoutsplit FOR EACH ROW EXECUTE FUNCTION public.update_muscle_group_trigger_function();
...
--
-- Name: exercisetoworkoutsplit ExerciseToWorkoutsplit_exercise_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: exercisetoworkoutsplit ExerciseToWorkoutsplit_workoutsplit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: aerobictracking aerobictracking_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: exercisetracking exercisetracking_exercisetosplit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: exercisetracking exercisetracking_workout_summary_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: user_reminder_settings user_reminder_settings_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: user_split_information user_split_information_split_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: user_split_information user_split_information_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: users_subs users_subs_user_id_fkey1; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: workout_summary workout_summary_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: workout_summary workout_summary_workoutsplit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: workoutplans workoutplans_trainer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: workoutplans workoutplans_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: workoutsplits workoutsplits_workout_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: exercises Allow all authenticated users to read exercises; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: user_reminder_settings Allow authenticated users to update their own reminder settings; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: users Allow user to view senders in their messages; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: aerobictracking Enable delete for auth users on aerobictracking; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: exercisetoworkoutsplit Enable delete for auth users on exercisetoworkoutsplit; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: messages Enable delete for auth users on messages; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: oauth_accounts Enable delete for auth users on oauth_accounts; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: users Enable delete for auth users on own profile; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: workoutplans Enable delete for auth users on workoutplans; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: workoutsplits Enable delete for auth users on workoutsplits; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: aerobictracking Enable insert for auth users on aerobictracking; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: exercisetoworkoutsplit Enable insert for auth users on exercisetoworkoutsplit; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: messages Enable insert for auth users on messages; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: oauth_accounts Enable insert for auth users on oauth_accounts; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: users Enable insert for auth users on own profile; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: workoutplans Enable insert for auth users on workoutplans; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: workoutsplits Enable insert for auth users on workoutsplits; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: users Enable insert for public users on own profile; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: aerobictracking Enable read access for auth users on aerobictracking; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: exercisetoworkoutsplit Enable read access for auth users on exercisetoworkoutsplit; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: messages Enable read access for auth users on messages; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: oauth_accounts Enable read access for auth users on oauth_accounts; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: users Enable read access for auth users on own profile; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: workoutplans Enable read access for auth users on workoutplans; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: workoutsplits Enable read access for auth users on workoutsplits; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: aerobictracking Enable update for auth users on aerobictracking; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: exercisetoworkoutsplit Enable update for auth users on exercisetoworkoutsplit; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: messages Enable update for auth users on messages; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: oauth_accounts Enable update for auth users on oauth_accounts; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: users Enable update for auth users on own profile; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: workoutplans Enable update for auth users on workoutplans; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: workoutsplits Enable update for auth users on workoutsplits; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: aerobictracking; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.aerobictracking ENABLE ROW LEVEL SECURITY;

--
-- Name: user_reminder_settings auth can INSERT own reminder settings; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: user_reminder_settings auth can SELECT own reminder settings; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: user_reminder_settings auth can UPDATE own reminder settings; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: exercisetoworkoutsplit; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.exercisetoworkoutsplit ENABLE ROW LEVEL SECURITY;

--
-- Name: exercisetracking; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.exercisetracking ENABLE ROW LEVEL SECURITY;

--
-- Name: exercisetracking exercisetracking_delete_by_summary_owner; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: exercisetracking exercisetracking_insert_by_summary_owner; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: exercisetracking exercisetracking_select_by_summary_owner; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: exercisetracking exercisetracking_update_by_summary_owner; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: oauth_accounts; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.oauth_accounts ENABLE ROW LEVEL SECURITY;

--
-- Name: user_reminder_settings; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.user_reminder_settings ENABLE ROW LEVEL SECURITY;

--
-- Name: user_split_information; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: workout_summary users can delete their workout summaries; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: workout_summary users can insert their workout summaries; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: workout_summary users can read their workout summaries; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: workout_summary users can update their workout summaries; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: users_subs; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.users_subs ENABLE ROW LEVEL SECURITY;

--
-- Name: workout_summary; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.workout_summary ENABLE ROW LEVEL SECURITY;

--
-- Name: workoutplans; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.workoutplans ENABLE ROW LEVEL SECURITY;

--
-- Name: workoutsplits; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: objects Allow insert for authenticated users; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Allow insert for authenticated users" ON storage.objects FOR INSERT TO authenticated WITH CHECK ((auth.role() = 'authenticated'::text));


--
-- Name: objects Allow read access to authenticated users; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Allow read access to authenticated users" ON storage.objects FOR SELECT TO authenticated USING ((auth.role() = 'authenticated'::text));


--
-- Name: objects Give users authenticated access to folder k8lqf3_0; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Give users authenticated access to folder k8lqf3_0" ON storage.objects FOR INSERT WITH CHECK (((bucket_id = 'profile_pics'::text) AND ((auth.role() = 'authenticated'::text) OR (auth.role() = 'anon'::text))));


--
-- Name: objects Give users authenticated access to folder k8lqf3_1; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Give users authenticated access to folder k8lqf3_1" ON storage.objects FOR SELECT USING (((bucket_id = 'profile_pics'::text) AND ((auth.role() = 'authenticated'::text) OR (auth.role() = 'anon'::text))));


--
-- Name: objects Give users authenticated access to folder k8lqf3_2; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Give users authenticated access to folder k8lqf3_2" ON storage.objects FOR UPDATE USING (((bucket_id = 'profile_pics'::text) AND ((auth.role() = 'authenticated'::text) OR (auth.role() = 'anon'::text))));


--
-- Name: objects Give users authenticated access to folder k8lqf3_3; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Give users authenticated access to folder k8lqf3_3" ON storage.objects FOR DELETE USING (((bucket_id = 'profile_pics'::text) AND ((auth.role() = 'authenticated'::text) OR (auth.role() = 'anon'::text))));
...
--
-- Name: supabase_realtime exercisetoworkoutsplit; Type: PUBLICATION TABLE; Schema: public; Owner: postgres
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.exercisetoworkoutsplit;
...
--
-- Name: FUNCTION housekeeping_compact_old_workouts(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION is_owner_of_workoutsplit(split_id_in bigint); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION refresh_user_split_information(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION update_muscle_group_trigger_function(); Type: ACL; Schema: public; Owner: postgres
--
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE extensions.hypopg_list_indexes TO postgres WITH GRANT OPTION;
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE extensions.hypopg_hidden_indexes TO postgres WITH GRANT OPTION;
...
--
-- Name: TABLE exercisetoworkoutsplit; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE "ExerciseToWorkoutsplit_id_seq"; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE aerobictracking; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE aerobictracking_id_seq; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE exercises_id_seq; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE exercisetracking; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE exercisetracking_id_seq; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE user_reminder_settings; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE user_split_information; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE user_split_information_id_seq; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE user_split_information_id_seq1; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN users.profile_image_url; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE users_subs; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE workoutsplits; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE v_exercisetoworkoutsplit_expanded; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE workout_summary; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE v_exercisetracking_expanded; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE v_exercisetracking_set_simple; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE v_prs; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE workoutplans; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE workoutplan_id_seq; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE workoutsplits_id_seq; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE messages_2025_08_10; Type: ACL; Schema: realtime; Owner: supabase_admin
--

GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE realtime.messages_2025_08_10 TO postgres;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE realtime.messages_2025_08_10 TO dashboard_user;


--
-- Name: TABLE messages_2025_08_11; Type: ACL; Schema: realtime; Owner: supabase_admin
--

GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE realtime.messages_2025_08_11 TO postgres;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE realtime.messages_2025_08_11 TO dashboard_user;
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE realtime.messages_2025_08_12 TO postgres;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE realtime.messages_2025_08_12 TO dashboard_user;
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE realtime.messages_2025_08_13 TO postgres;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE realtime.messages_2025_08_13 TO dashboard_user;
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE realtime.messages_2025_08_14 TO postgres;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE realtime.messages_2025_08_14 TO dashboard_user;
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE realtime.messages_2025_08_15 TO postgres;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE realtime.messages_2025_08_15 TO dashboard_user;
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE realtime.messages_2025_08_16 TO postgres;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE realtime.messages_2025_08_16 TO dashboard_user;
...
\unrestrict nelqN0KEJEmir87KpqXHnK1dieLIzWnztWQ4e9VfcRRwtV2qJCaIQuYis9mlwdO
