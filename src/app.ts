...
import aerobicsRoutes from './features/aerobics/aerobics.routes.ts';
import analyticsRoutes from './features/analytics/analytics.routes.ts';
import authRoutes from './features/auth/auth.routes.ts';
import bootsrapRoutes from './features/bootstrap/bootstrap.routes.ts';
import exercisesRoutes from './features/exercises/exercises.routes.ts';
import messagesRoutes from './features/messages/messages.routes.ts';
import oauthRoutes from './features/oauth/oauth.routes.ts';
import pushRoutes from './features/push/push.routes.ts';
import userRoutes from './features/user/user.routes.ts';
import videoAnalysisRoutes from './features/videoAnalysis/videoAnalysis.routes.ts';
import webSocketsRoutes from './features/webSockets/webSockets.routes.ts';
import workoutRoutes from './features/workout/workout.routes.ts';
