...
/** Raised when a post cannot receive a reaction. */
...
/** Raised when a reaction is absent or inaccessible. */
export class ReactionNotFoundError extends ApplicationNotFoundError {
  public constructor() {
