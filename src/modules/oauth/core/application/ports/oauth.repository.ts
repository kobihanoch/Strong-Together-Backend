import type { OAuthProvider } from '../models/oauth.models';
...
export abstract class OAuthRepository {
  ...
  abstract linkByVerifiedEmail(provider: OAuthProvider, email: string, providerUserId: string): Promise<string | null>;
  abstract createUser(
