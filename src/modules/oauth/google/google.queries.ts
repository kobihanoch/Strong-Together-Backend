...
import { ensureUniqueUsername } from '../../../utils/oauthUtils.ts';
...
export async function queryFindUserIdWithGoogleUserId(googleUserId: string): Promise<OAuthLookupResult> {
