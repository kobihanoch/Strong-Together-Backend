 ...
 * }
 */
export const queryGetWorkoutRMs = async (userId: string): Promise<WorkoutRMsResponse> => {
...
export const queryGoalAdherence = async (userId: string): Promise<GoalAdherenceResponse> => {
