...
import { createWebSocketTicketResponseSchema, loginResponseSchema } from '@strong-together/shared';
...
describe('WebSocketsController', () => {
  it('POST /api/websocket-tickets returns a signed ticket with socket claims', async () => {
    ...
    expectSchema(createWebSocketTicketResponseSchema, response.body);
  ...
  it('POST /api/websocket-tickets rejects missing username with 400', async () => {
