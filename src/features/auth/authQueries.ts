...
export async function queryUserByIdentifierForLogin(
  identifier: string,
...
export async function querySetUserFirstLoginFalse(
  userId: string,
): Promise<{ id: string }[]> {
...
export async function queryBumpTokenVersionAndGetSelfData(
  userId: string,
