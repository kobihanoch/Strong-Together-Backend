...
import { queryBumpTokenVersionAndGetSelfData, querySetUserFirstLoginFalse } from '../auth/authQueries.ts';
import {
...
} from './oauthQueries.ts';
import { sendSystemMessageToUserWhenFirstLogin } from '../../services/messagesService.ts';
import type { AppleOAuthBody, GoogleOAuthBody } from '../../types/api/oAuth/requests.ts';
import type { OAuthLoginResponse, ProceedLoginResponse } from '../../types/api/oAuth/responses.ts';
...
const buildCnfClaim = (jkt: string) => ({
  cnf: {
