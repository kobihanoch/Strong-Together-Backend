...
DROP VIEW "analytics"."v_exercise_tracking_set_expanded";--> statement-breakpoint
CREATE VIEW "analytics"."v_exercise_tracking_set_expanded" WITH (security_invoker = true) AS (
    SELECT
      et.id,
