...
<html lang="en">
  ...
  <body style="margin:0; padding:0; background:#f9f9f9;">
    <!-- Preheader -->
    <div style="display:none;overflow:hidden;line-height:1px;opacity:0;max-height:0;max-width:0;color:transparent;">
      Confirm your new Strong Together email address.
    </div>
      ...
      <tr>
        <td align="center" style="padding:40px 12px;">
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                 style="max-width:600px;background:#ffffff;border-radius:8px;box-shadow:0 0 10px rgba(0,0,0,0.05);">
            <tr>
              <td style="padding:30px;">
                <table role="presentation" width="100%">
                  <tr>
                ...
                <p style="margin:0 0 8px 0;font-family:Segoe UI, Roboto, Helvetica, Arial, sans-serif;
                          font-size:26px;line-height:1.3;color:#333;text-align:center;">
                  Confirm Your New Email
                </p>

                <p style="margin:0;font-family:Segoe UI, Roboto, Helvetica, Arial, sans-serif;
                          font-size:14px;line-height:1.6;color:#555;text-align:center;">
                  Hi <strong>${fullName}</strong>,<br/>
                  you requested to change your Strong Together email address.<br/>
                  ...
                  <tr>
                    <td align="center" style="padding:24px;">
                      ...
                      <a href="${confirmUrl}" target="_blank" rel="noopener noreferrer"
                         style="background:#2979ff;color:#fff;display:inline-block;padding:12px 24px;border-radius:16px;
                                font-family:Segoe UI, Roboto, Helvetica, Arial, sans-serif;font-size:18px;">
                ...
                <p style="margin:24px 0 0;font-family:Segoe UI, Roboto, Helvetica, Arial, sans-serif;
                          font-size:13px;color:#888;text-align:center;">
                  If you did not request this change, please ignore this email.<br/>
                  Your current email will remain active.
                </p>
